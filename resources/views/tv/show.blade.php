...
@section('content')
    ...
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <div class="md:ml-24">
                <h2 class="text-4xl mt-4 mb-2 md:mt-0 font-semibold">{{ $tvshow['name'] }} <span class="ml-2">({{ $tvshow['first_air_year'] }})</span></h2>
...
{{--                    <div class="flex mt-2">--}}
{{--                        @foreach($tvshow['production_companies'] as $pCompany)--}}
{{--                            <div class="mr-8">--}}
...
{{--                </div>--}}
                <div x-data="{ isOpen: false }">
                    @if(count($tvshow['videos']['results']) > 0)
                        <div class="mt-12">
                            <button href="https://www.youtube.com/watch?v={{ $tvshow['videos']['results'][0]['key'] }}"
